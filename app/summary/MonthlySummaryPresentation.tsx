...
function TitleSlide({ data }: { data: MonthlySummaryData }) {
  return (
    <div className="pres-slide-content flex flex-col items-center justify-center text-center h-full">
      ...
      <div className="absolute bottom-20 right-20 w-80 h-80 bg-fuchsia-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
      ...
      <div className="pres-anim-scale relative z-10">
        ...
        <div className="mt-10 flex items-center gap-2 text-white/30 text-sm animate-bounce">
  ...
  return (
    <div className={`pres-slide-content flex flex-col items-center justify-center text-center h-full`}>
      <div className="absolute inset-0 opacity-20">
        <div className={`absolute top-1/4 left-1/3 w-96 h-96 bg-gradient-to-br ${colors.gradient} rounded-full blur-3xl animate-pulse`} />
      </div>
  ...
  return (
    <div className="pres-slide-content flex flex-col items-center justify-center text-center h-full">
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-fuchsia-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "0.8s" }} />
      </div>

      <div className="pres-anim-scale relative z-10">
        <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl flex items-center justify-center shadow-2xl shadow-emerald-500/30">
...
export default function MonthlySummaryPresentation({
  ...
  return (
    <div className="pres-fullscreen fixed inset-0 z-[100] bg-slate-950 flex flex-col overflow-hidden select-none">
      {/* Background gradient */}
      ...
      <div className="absolute top-3 left-4 right-4 flex items-center justify-between z-20">
        <button
          onClick={onExit}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white/60 text-xs font-medium transition-colors"
        >
      ...
      <div
        key={animKey}
        className={`flex-1 relative z-10 pt-14 pb-16 ${direction === "next" ? "pres-slide-enter-next" : "pres-slide-enter-prev"}`}
      >
        {renderSlide()}
      </div>
